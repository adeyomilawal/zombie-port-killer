...
const macos_adapter_1 = require("../macos.adapter");
...
describe('MacOSAdapter', () => {
    ...
    beforeEach(() => {
        adapter = new macos_adapter_1.MacOSAdapter();
        jest.clearAllMocks();
    ...
    describe('killProcess', () => {
        it('should kill process with SIGTERM by default', async () => {
            mockExecSync
                .mockReturnValueOnce(undefined) // kill -15 12345 succeeds
                .mockImplementationOnce(() => {
        ...
        it('should kill process with SIGKILL when force is true', async () => {
            mockExecSync
                .mockReturnValueOnce(undefined) // kill -9 12345 succeeds
                .mockImplementationOnce(() => {
                throw new Error('No such process'); // ps -p 12345 fails (process is dead)
            });
