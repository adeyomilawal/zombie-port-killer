...
describe("Auto Command Integration", () => {
    ...
    beforeAll(() => {
        ...
        testConfigPath = nativeJoin(os_1.default.tmpdir(), `.zkill-test-auto-${Date.now()}`);
    ...
    describe("zkill auto status", () => {
        it("should show disabled status by default", () => {
            ...
            const output = (0, child_process_1.execSync)(`node "${cliPath}" auto status`, {
                encoding: "utf-8",
                stdio: "pipe",
            });
        ...
        it.skip("should show enabled status after enabling", (done) => {
            ...
            const cliPath = path_1.default.join(__dirname, "../../../dist/cli.js");
            (0, child_process_1.execSync)(`node "${cliPath}" auto enable`, {
                encoding: "utf-8",
                stdio: "pipe",
            });
    ...
    describe("zkill auto enable", () => {
        it("should enable auto-kill", () => {
            const cliPath = path_1.default.join(__dirname, "../../../dist/cli.js");
            const output = (0, child_process_1.execSync)(`node "${cliPath}" auto enable`, {
                encoding: "utf-8",
                stdio: "pipe",
            });
            expect(output).toMatch(/enabled|on/i);
    ...
    describe("zkill auto disable", () => {
        it("should disable auto-kill", () => {
            ...
            // Then disable it
            const output = (0, child_process_1.execSync)(`node "${cliPath}" auto disable`, {
                encoding: "utf-8",
                stdio: "pipe",
            });
            expect(output).toMatch(/disabled|off/i);
        ...
        it("should handle multiple disable calls", () => {
            const cliPath = path_1.default.join(__dirname, "../../../dist/cli.js");
            // Disable first time
            (0, child_process_1.execSync)(`node "${cliPath}" auto disable`, {
                encoding: "utf-8",
                stdio: "pipe",
            });
            // Disable again
    ...
    describe("zkill auto check", () => {
        it("should check for ports to clean up", () => {
            const cliPath = path_1.default.join(__dirname, "../../../dist/cli.js");
            try {
                const output = (0, child_process_1.execSync)(`node "${cliPath}" auto check`, {
                    encoding: "utf-8",
                    stdio: "pipe",
                });
        ...
        it("should handle check command", () => {
            const cliPath = path_1.default.join(__dirname, "../../../dist/cli.js");
            try {
                (0, child_process_1.execSync)(`node "${cliPath}" auto check`, {
                    encoding: "utf-8",
                    stdio: "pipe",
                });
    ...
    describe("invalid auto commands", () => {
        it("should handle invalid action", () => {
            const cliPath = path_1.default.join(__dirname, "../../../dist/cli.js");
            try {
                (0, child_process_1.execSync)(`node "${cliPath}" auto invalid`, {
                    encoding: "utf-8",
                    stdio: "pipe",
                });
    ...
    describe("auto-kill persistence", () => {
        it("should persist auto-kill state across service instances", () => {
            ...
            // Create new instance
            const newStorage = new storage_service_1.StorageService();
            expect(newStorage.isAutoKillEnabled()).toBe(true);
            // Disable and verify
            newStorage.setAutoKill(false);
            const anotherStorage = new storage_service_1.StorageService();
            expect(anotherStorage.isAutoKillEnabled()).toBe(false);
        });
    });
});
//# sourceMappingURL=auto.command.integration.test.js.map